...
4. Set the baud rate to 115200.
	- Note that the `fcu_bridge_00X.cpp` files use a functional baud rate of 460800, while the networking module uses 115200. Do not to change the functional baud rate to 115200, as this will cause errors.
...
7. In the chosen bridge file, refactor the IP address to match the IP address of your desired drone. You can find the IP address on line 27, which will look something like `static char* DRONE_IP = "192.168.X.X";`. After any changes, save your code.
